"""
Production settings for aids_jiance project.
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['aids-jiance.com', ])
...
QINIU_SECRET_KEY = env('DJANGO_QINIU_SECRET_KEY')
...
#                          default='aids_jiance <noreply@aids-jiance.com>')
# EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[aids_jiance]')
